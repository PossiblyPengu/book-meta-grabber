# 📚 Book Meta Grabber — iOS (Capacitor)
...
├── vite.config.js           ← Builds ios-app/ → dist/
├── ios-app/
│   ├── index.html           ← App shell (3 tabs + editor + sheets)
│   ├── css/
│   │   └── mobile.css       ← iOS Liquid Glass design system
│   └── js/
│       └── app.js           ← All UI logic, state, routing, haptics
├── src/
...
│   ├── fileSources.js       ← Local picker, iCloud, Google Drive OAuth
│   └── storage.js           ← Capacitor Preferences persistence
